...
class MCP23017Inputs:
    """Class to handle 16 switch inputs using MCP23017 with efficient
    XOR-based change detection."""
    ...
    def _read_raw_states(self):
        ...
        return (value_b << 8) | value_a  # Combine Port B and Port A (low byte)
    ...
    def read_switch(self, switch_id):
        ...
        if new_states ^ self.last_states:  # If any bit has changed
            ...
            debounced_states = self._read_raw_states()  # Again for stability
